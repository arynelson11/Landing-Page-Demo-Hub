            ...
            <div className="space-y-16">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:gap-12 max-w-5xl mx-auto">
                    ...
                    <MotionSection delay={0.1} className="h-full">
                        <Card className="flex h-full flex-col justify-between p-8 sm:p-10 transition-all duration-300 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 hover:ring-1 hover:ring-blue-100 group bg-white/50 backdrop-blur-sm">
                    ...
                    <MotionSection delay={0.2} className="h-full">
                        <Card className="flex h-full flex-col justify-between p-8 sm:p-10 border-zinc-200 bg-zinc-50/50 transition-all duration-300 hover:border-indigo-200 hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 hover:ring-1 hover:ring-indigo-100 group">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
